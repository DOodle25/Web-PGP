    ...
    <section className="panel">
      ...
      {mode === "decrypt" && (
        <div className="card">
          ...
          {verifyMode === "encrypt-then-sign" && (
            <label>
              ...
              <textarea
                ...
                title="Paste the detached signature from the sender."
              />
            </label>
          )}
          <div className="actions">
          ...
          {verifyResult && (
            <span
              className={`badge ${verifyResult === "valid" ? "success" : "danger"}`}
            >
          ...
          <label>
            Output
            <textarea rows="6" value={plaintext} readOnly className="mono" />
          </label>
        </div>
      )}
      ...
      {mode !== "decrypt" && ciphertext && (
        <div className="card">
          ...
          {showOutput && (
            <>
              <textarea rows="6" value={ciphertext} readOnly className="mono" />
              {signature && (
                <textarea
                  rows="6"
                  value={signature}
